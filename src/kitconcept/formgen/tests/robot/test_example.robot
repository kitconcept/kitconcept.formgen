...
#
#  $ bin/test -s kitconcept.formgen -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src kitconcept.formgen.testing.KITCONCEPT_FORMGEN_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/formgen/tests/robot/test_example.robot
#
